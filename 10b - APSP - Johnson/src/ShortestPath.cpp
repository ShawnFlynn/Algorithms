...
ShortestPath::ShortestPath(string filename):shortest_path_distance(0),
	...
	Graph SSSPgraph = Graph(graph_size);
...
ShortestPath::ShortestPath(string filename, string algorithm):
	...
	APSPgraph = Graph(graph_size, graph_size, algorithm);
	...
	for (int k=0; k<3; k++) {
		for (int i=0; i<graph_size; i++) {
			APSPgraph.set_APSP_edge_value(i, i, k, 0);
		}
	}
...
int ShortestPath::getShortestPathDistance() {
...
string ShortestPath::getAPSPShortestPath(string algorithm) {
...
string ShortestPath::getJShortestPath(string filename) {
...
long ShortestPath::getAPSPShortestShortestPath() {
...
void ShortestPath::print_APSPgraph(int k) {
